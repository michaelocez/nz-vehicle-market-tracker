  ...
  return (
    <header className="hero" id="overview">
      ...
      <div className="hero-content wrap">
        ...
        <div
          className="hero-stat"
          aria-label={`${number.format(view.latestTotal)} passenger vehicles entered the fleet in ${prettyMonth(view.latest)}`}
        >
          ...
          <div className="split-labels">
            <span>
              <b>{percent(view.nzNew / view.latestTotal)}</b> NZ-new
            </span>
            <span>
              <b>{percent(view.used / view.latestTotal)}</b> used imports
            </span>
          </div>
        </div>
      </div>
